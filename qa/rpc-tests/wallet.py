...
#   c) node1 mines 32 blocks, so now node 0 has 500000UNNY, node 1 has 4250UNNY, node2 has none.
#   d) node0 sends 601 UNNY to node2, in two transactions (301 UNNY, then 300 UNNY).
