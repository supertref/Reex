...
RESOURCES += src/qt/unnycore.qrc src/qt/unnycore_locale.qrc

TRANSLATIONS += src/qt/locale/unnycore_bg.ts \
                src/qt/locale/unnycore_de.ts \
                src/qt/locale/unnycore_en.ts \
                src/qt/locale/unnycore_es.ts \
                src/qt/locale/unnycore_fi.ts \
                src/qt/locale/unnycore_fr.ts \
                src/qt/locale/unnycore_it.ts \
                src/qt/locale/unnycore_ja.ts \
                src/qt/locale/unnycore_pl.ts \
                src/qt/locale/unnycore_pt.ts \
                src/qt/locale/unnycore_ru.ts \
                src/qt/locale/unnycore_sk.ts \
                src/qt/locale/unnycore_sv.ts \
                src/qt/locale/unnycore_vi.ts \
                src/qt/locale/unnycore_zh_CN.ts \
                src/qt/locale/unnycore_zh_TW.ts
