...
/** Utility functions used by the unnycore Qt UI.
 */
namespace GUIUtil
{
...
// Render UNNY addresses in monospace font
...
// Parse "unnycore:" URI into recipient object, return true on successful parsing
