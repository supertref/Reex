...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("unnycore Core"),
     ...
     * override -datadir in the unnycore.conf file in the default data directory
     * (to be consistent with unnycored behavior)
     */
    if (dataDir != getDefaultDataDirectory())
