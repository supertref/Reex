...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Reliance Core"),
     ...
     * override -datadir in the reliance.conf file in the default data directory
     * (to be consistent with relianced behavior)
     */
    if (dataDir != getDefaultDataDirectory())
