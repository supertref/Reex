                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UnnyCore") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UNNY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unnycore: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UnnyCore"), this);
    aboutAction->setStatusTip(tr("Show information about UnnyCore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for unnycore"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UNNY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UNNY addresses"));
    ...
    openAction->setStatusTip(tr("Open a unnycore: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UnnyCore help message to get a list with possible unnycore command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("UnnyCore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to unnycore network", "", count));
}
...
{
    QString strTitle = tr("UnnyCore"); // default title
