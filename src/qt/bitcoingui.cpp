                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Reliance Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reliance: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Reliance Core"), this);
    aboutAction->setStatusTip(tr("Show information about Reliance Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Reliance"));
    ...
    openAction->setStatusTip(tr("Open a reliance: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Reliance Core help message to get a list with possible Reliance command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Reliance Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Reliance network", "", count));
}
...
{
    QString strTitle = tr("Reliance Core"); // default title
