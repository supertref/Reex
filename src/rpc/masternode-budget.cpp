...
// Copyright (c) 2017-2018 The Unnycore developers
...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a unnycore initiative\n"
            "  vote-alias         - Vote on a unnycore initiative\n"
            "  vote               - Vote on a unnycore initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"unny-address\" monthy-payment\n"
            ...
            "5. \"unny-address\":   (string, required) UNNY address to send payments to\n"
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"unny-address\" monthy-payment \"fee-tx\"\n"
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) UNNY address of payment\n"
