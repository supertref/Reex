...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("unnycore Core unnycore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  unnycore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unnycore transaction") + "\n" +
                               "  unnycore-tx [options] -create [commands]   " + _("Create hex-encoded unnycore transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded unnycore transaction
