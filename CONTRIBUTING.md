Contributing to Reliance Core
==================================

The Reliance Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Reliance Core project, and is not to be
confused with overall Reliance Network Protocol consensus changes.

Whether a pull request is merged into Reliance Core rests with the project merge
...
Patches that change Reliance consensus rules are considerably more involved than
...
Where a patch set proposes to change the Reliance consensus, it must have been
...
The project leader is the release manager for each Reliance Core release.
