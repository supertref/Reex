Contributing to Reecore Core
==================================

The Reecore Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Reecore Core project, and is not to be
confused with overall Reecore Network Protocol consensus changes.

Whether a pull request is merged into Reecore Core rests with the project merge
...
Patches that change Reecore consensus rules are considerably more involved than
...
Where a patch set proposes to change the Reecore consensus, it must have been
...
The project leader is the release manager for each Reecore Core release.
