Contributing to unnycore Core
==================================

The unnycore Core project operates an open contributor model where anyone is
...
The following applies to code changes to the unnycore Core project, and is not to be
confused with overall unnycore Network Protocol consensus changes.

Whether a pull request is merged into unnycore Core rests with the project merge
...
Patches that change unnycore consensus rules are considerably more involved than
...
Where a patch set proposes to change the unnycore consensus, it must have been
...
The project leader is the release manager for each unnycore Core release.
