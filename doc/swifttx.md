...
This mechanism has been integrated into Bitcore-Node-Reecore which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Reecore/insight-api-Reecore#web-socket-api](https://github.com/Reecore/insight-api-Reecore#web-socket-api)
* API: [https://github.com/Reecore/insight-api-Reecore#swifttx-transactions](https://github.com/Reecore/insight-api-Reecore#swifttx-transactions)
...
By default, the Reecore Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Reecore Core daemon:
