...
This mechanism has been integrated into Bitcore-Node-unnycore which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/unnycore/insight-api-unnycore#web-socket-api](https://github.com/unnycore/insight-api-unnycore#web-socket-api)
* API: [https://github.com/unnycore/insight-api-unnycore#swifttx-transactions](https://github.com/unnycore/insight-api-unnycore#swifttx-transactions)
...
By default, the unnycore Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the unnycore Core daemon:
