...
reecore now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<reecore_address\> \<monthly_payment_reecore\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<reecore_address\> \<monthly_payment_reecore\> \<collateral_hash\>
