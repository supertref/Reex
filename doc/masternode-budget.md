...
Reliance now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<reliance_address\> \<monthly_payment_reliance\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<reliance_address\> \<monthly_payment_reliance\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a Reliance initiative
 * vote-alias         - Vote on a Reliance initiative
 * vote               - Vote on a Reliance initiative/budget
