...
Intro
-----
Reliance (REL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Reliance utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run reliance-qt.exe.

Reliance Core is the original Reliance client and it builds the backbone of the network.
However, it downloads and stores the entire history of Reliance transactions;
