...
Intro
-----
reecore (REEX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. reecore utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run reecore-qt.exe.

reecore Core is the original reecore client and it builds the backbone of the network.
However, it downloads and stores the entire history of reecore transactions;
