...
In order to support loading of multiple wallets in reliance-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is reliance.cpp.
...
Changes to reliance.cpp
----------------------
reliance.cpp is the entry point into reliance-qt, and as such, will require some minor modifications to provide hooks for
